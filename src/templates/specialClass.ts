const specialClass = `<!DOCTYPE html>
<html>
<head>
...
<body style="background-color: #e9ecef;">
  ...
  <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    Thank you for registering for Special Class Training
  </div>
  <!-- end preheader -->
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="https://www.web3bridge.com/" target="_blank" rel="noopener noreferrer" style="display: inline-block;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td bgcolor="#ffffff" align="left" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              ...
              <p>
              I am excited to have you among the very few that get to register for the Web3bridge specialized class. Early this year we decided to start the specialized class based on requests by individuals who want some level of flexibility in their learning and trust us to deliver an amazing result, and your guess is as good as mine with the results we have achieved.
              </p>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
              <p style="margin: 0;">You received this email because we received a request for your  special class registration. If you didn't request registration you can safely delete this email.</p>
            </td>
          </tr>
          <!-- end permission -->
